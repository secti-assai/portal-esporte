    ...
    <div class="bg-white shadow-lg rounded-2xl w-full max-w-md p-8">
        ...
        <form method="POST" action="{{ route('admin.login.post') }}">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-600" required>
            </div>

            <div class="mb-6">
                <label class="block text-sm font-semibold mb-2">Senha</label>
                <input type="password" name="password" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-600" required>
            </div>
